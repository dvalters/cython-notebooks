...
#cdef np.int64_t jmax
#cdef np.int64_t imax
#cdef np.int64_t kmax
...
def voxelspace(np.ndarray[np.int32_t, ndim=3] voxelspace, np.ndarray[np.int32_t, ndim=2] one_month_data):
    cdef int i = 0			      	      	
    cdef int j = 0
    cdef int NAN = -9999		      
